...
This page provides a gallery of examples to showcase the kinds of plots
you can create with `fplot`. Each example includes the code in both
Fennel and Lua, along with the resulting plot.
...
Creating a bar chart using the `boxes` style, which is great for
categorical data.
