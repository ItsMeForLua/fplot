...
% This is kind of basic, so I'll probably update this by using lstset blocks I've used in other documentations.
\lstset{
...
% Define the Lua language for the PDF compilation seperately (so not for pandoc)
\lstdefinelanguage{Lua}{
	morekeywords={and,break,do,else,elseif,end,false,for,function,if,in,local,nil,not,or,repeat,return,then,true,until,while,require},
	morecomment=[l]{--},
	morecomment=[s]{--[[}{]]},
	morestring=[b]",
	morestring=[b]'
...
\hypersetup{
	...
	filecolor=magenta,
	urlcolor=cyan,
	pdftitle={fplot Wiki Documentation},
}

\title{\textbf{fplot Wiki Documentation}}
\author{}
\date{}
...
-- Multiplot Configuration (in the last table)
{
	...
	\textit{(The resulting plot generated by fplot)}
	
	\begin{center}
		\fbox{\textit{[Image: P6.ex.Plot1]}}
	\end{center}
